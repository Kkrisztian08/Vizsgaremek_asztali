...
public class Dog {
    ...
    public Dog(int id, String name, String gender, String likely_bday, String species, String external_property, String description, int interest, Integer adoption_id) {
        this.id = id;
        this.name = name;
        this.gender = gender;
