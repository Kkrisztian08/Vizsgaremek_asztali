...
public class ProgramHourDayApi {
    ...
    public static List<ProgramHourDay> get() throws IOException {
        ...
        Type type = new TypeToken<List<ProgramHourDay>>(){}.getType();
        return jsonConverted.fromJson(json,type);
    }
    public static ProgramHourDay post(ProgramHourDay uj) throws IOException {
        String ujJson = jsonConverted.toJson(uj);
        String json = Api.post(API_URL, ujJson);
        return jsonConverted.fromJson(json, ProgramHourDay.class);
    }
